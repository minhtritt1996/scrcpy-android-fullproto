...
- Clipboard bridge (auto):
  - clipboard text sync runs continuously between B and C over control channel
  - loop protection and debounce are applied to avoid clipboard ping-pong
- Session UI behavior:
